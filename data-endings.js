...
const DATA_ENDINGS = {
  ...
  endingMeta: {
    legend: { emoji:"👑", title:"封神级 · 时代的造王者", color:"#b8860b",
    ...
    master: { emoji:"🌟", title:"一线传奇 · 穿越周期的老兵",  color:"#2c5282",
    ...
    veteran: { emoji:"💼", title:"资深合伙人 · 稳健的常胜者", color:"#3c6b4f",
    ...
    steady: { emoji:"⚖️", title:"稳进玩家 · 及格线上的幸存者", color:"#5a6470",
    ...
    rollercoaster: { emoji:"🎢", title:"过山车选手 · 大起大落的赌徒", color:"#9a7b3a",
    ...
    exit: { emoji:"📉", title:"离场的勇者 · 时代浪潮的祭品", color:"#a8453a",
    ...
    earlyout: { emoji:"🏥", title:"健康透支 · 倒在半途的拼命者", color:"#7d5a3a",
